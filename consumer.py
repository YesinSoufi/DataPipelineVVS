    ...
    if message is not None:
        ...
        if len(message) > 1500:
            ...
            if verspaetung != 0:
                ...
                curser = connection.cursor()
                curser.execute("INSERT IGNORE INTO vvsdaten (id,datum,estimated,timetabled,verspaetung,haltestelle,zeitstempel) VALUES (%s,%s,%s,%s,%s,%s,%s)",(doppelcode,currentdate,est2[0],tbl2[0],verspaetung,haltestelle,tbldt))
                curser.close()
                connection.commit()
